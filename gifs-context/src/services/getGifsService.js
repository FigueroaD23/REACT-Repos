...
export default async function({keyword,limit} = {keyword:'Morty',limit:10}){    
    const apiURL = `${API_URL}api_key=${API_KEY}&q=${keyword}&limit=${limit}&offset=0&rating=g&lang=en`
    try {
